  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-slate-900/95 backdrop-blur-md border-b border-purple-800/50 shadow-lg shadow-purple-500/10"
    ...
    >
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative">
              <input
                type="text"
                placeholder="Search..."
                className="bg-gray-800 text-gray-300 placeholder-gray-500 px-4 py-2 pl-10 pr-8 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-64"
              />
      ...
      {isOpen && (
        <motion.div
          ...
          className="md:hidden bg-slate-900/95 backdrop-blur-md border-t border-purple-800/50"
        >
          <div className="px-4 pt-2 pb-3 space-y-1">
            ...
            <div className="pt-4 border-t border-purple-800/50 mt-4">
